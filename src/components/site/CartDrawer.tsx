        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-border">
          <div>
            ...
            <h3 className="font-serif text-xl text-foreground">
              Ваш сундукъ ({items.length})
            </h3>
          </div>
          <button
            onClick={close}
            aria-label="Закрыть корзину"
            className="text-foreground/70 hover:text-gold transition-colors p-1"
          >
          ...
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center gap-4 py-20">
              ...
              <p className="text-xs text-muted-foreground tracking-widest uppercase">
                Выберите что-то из коллекции
              </p>
              <button
                onClick={close}
                className="mt-4 text-[11px] tracking-[0.3em] uppercase border-b border-gold text-gold pb-1 hover:opacity-80"
              >
                К коллекции
              </button>
            </div>
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="text-foreground/40 hover:text-crimson transition-colors text-xs"
                        aria-label="Удалить"
                      >
                        <X size={14} />
                      </button>
                    ...
                    <div className="mt-auto flex items-center justify-between pt-3">
                      <div className="flex items-center border border-border">
                        <button
                          ...
                          className="px-2.5 py-1.5 text-foreground/70 hover:text-gold"
                          aria-label="Меньше"
                        >
                          <Minus size={12} />
                        </button>
        ...
        {items.length > 0 && (
          <div className="border-t border-border px-6 py-5 bg-surface-elevated">
            ...
            <p className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground mb-5">
              Доставка и налоги · при оформленiи
            </p>
            <button className="group w-full bg-foreground text-background py-4 text-[11px] tracking-[0.3em] uppercase font-medium flex items-center justify-center gap-3 hover:bg-gold transition-colors duration-300">
              Оформить заказъ
